...
class T_register_sk_model extends CI_Model
{

    public $table = 't_register_sk';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file T_register_sk_model.php */
/* Location: ./application/models/T_register_sk_model.php */
